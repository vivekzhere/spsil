...
The SPSIL \textbf{strcpy} statement copies a string in one memory location to another memory location. Registers which store the  memory locaiton of the destination and the source are given as R{\tiny d} and R{\tiny s} respectively.\\
